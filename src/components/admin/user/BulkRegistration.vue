    ...
    <el-dialog
      ...
      <el-form :model="loginForm" :rules="rules" ref="loginForm"
        ...
        <el-form-item label="姓名" prop="name">
          <el-input type="text" v-model="loginForm.name" placeholder="姓名"
                    auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item label="联系电话" prop="phone">
          <el-input type="text" v-model="loginForm.phone" placeholder="联系电话"
                    auto-complete="off" ></el-input>
        </el-form-item>
        <el-form-item  label="E-Mail" prop="email">
          <el-input type="text" v-model="loginForm.email" placeholder="E-Mail"
                    auto-complete="off"></el-input>
        </el-form-item>

    ...
    <el-dialog
      ...
      <el-form :model="purchaseOrderPayConfirmForm" style="text-align: left" ref="purchaseOrderPayConfirmForm">
        ...
        <el-row :gutter="10">
          ...
          <el-col :span="12">
            <el-form-item label="付费凭证:" :label-width="formLabelWidth2" prop="img">
              <img :src="purchaseOrderPayConfirmForm.img" alt="付费凭证" >              
...
export default {
  ...
  methods: {
    ...
    onSubmit () {
      ...
      this.$axios.post('/admin/v1/pri/batchFee/payconfirm', {
